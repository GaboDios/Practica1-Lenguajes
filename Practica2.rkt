...
;; 2. Una funci ́on que recibe una lista de n ́umeros enteros lst y regresa una lista
...
;; 6. Una funcion que recibe una lista de n ́umeros lst enteros y devuelve un
